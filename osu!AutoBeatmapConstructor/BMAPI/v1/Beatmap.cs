...
namespace BMAPI.v1
{
    ...
    public class Beatmap : BeatmapInfo
    {
        ...
        public Beatmap(string beatmapFile = "")
        {
            ...
            BM_Sections.Add("Title,TitleUnicode,Artist,ArtistUnicode,Creator,Version,Source,Tags,BeatmapID,BeatmapSetID", "Metadata");
        ...
        public Beatmap(Beatmap baseMap)
        {
            Info = baseMap.Info;
            //Info
            ...
            BeatmapHash = baseMap.BeatmapHash;

            //General
            AudioFilename = baseMap.AudioFilename;
            AudioLeadIn = baseMap.AudioLeadIn;
            PreviewTime = baseMap.PreviewTime;
            Countdown = baseMap.Countdown;
            SampleSet = baseMap.SampleSet;
            StackLeniency = baseMap.StackLeniency;
            Mode = baseMap.Mode;
            LetterboxInBreaks = baseMap.LetterboxInBreaks;
            SpecialStyle = baseMap.SpecialStyle;
            CountdownOffset = baseMap.CountdownOffset;
            OverlayPosition = baseMap.OverlayPosition;
            SkinPreference = baseMap.SkinPreference;
            WidescreenStoryboard = baseMap.WidescreenStoryboard;
            UseSkinSprites = baseMap.UseSkinSprites;
            StoryFireInFront = baseMap.StoryFireInFront;
            EpilepsyWarning = baseMap.EpilepsyWarning;
            CustomSamples = baseMap.CustomSamples;
            EditorBookmarks = baseMap.EditorBookmarks;
            EditorDistanceSpacing = baseMap.EditorDistanceSpacing;
            AudioHash = baseMap.AudioHash;
            AlwaysShowPlayfield = baseMap.AlwaysShowPlayfield;

            //Editor (Other Editor tag stuff (v12))
            GridSize = baseMap.GridSize;
            Bookmarks = baseMap.Bookmarks;
            BeatDivisor = baseMap.BeatDivisor;
            DistanceSpacing = baseMap.DistanceSpacing;
            CurrentTime = baseMap.CurrentTime;
            TimelineZoom = baseMap.TimelineZoom;

            //Metadata
            Title = baseMap.Title;
            TitleUnicode = baseMap.TitleUnicode;
            Artist = baseMap.Artist;
            ArtistUnicode = baseMap.ArtistUnicode;
            Creator = baseMap.Creator;
            Version = baseMap.Version;
            Source = baseMap.Source;
            Tags = baseMap.Tags;
            BeatmapID = 0;
            BeatmapSetID = baseMap.BeatmapSetID;

            //Difficulty
            HPDrainRate = baseMap.HPDrainRate;
            CircleSize = baseMap.CircleSize;
            OverallDifficulty = baseMap.OverallDifficulty;
            ApproachRate = baseMap.ApproachRate;
            SliderMultiplier = baseMap.SliderMultiplier;
            SliderTickRate = baseMap.SliderTickRate;
            ...
            //Events (BG)
            this.Events = baseMap.Events;

            //Timing points
            this.TimingPoints = baseMap.TimingPoints;
    }
        ...
        public void regenerateFilename()
        {
            this.Filename = Artist + " - " + Title + " (" + Creator + ") " + "[" + Version + "]";
        }
